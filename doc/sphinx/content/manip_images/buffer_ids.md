...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------ | -------------------------------------------------------------------------------------------------------- | ----- | ------------------------------- |
| `ALGO_DEBUG`                    | Proprietary data used for troubleshooting by ifm. For internal use only.                                                                                                           | Yes                    | NA                                                                                                     | ??  | Native                        |
| `AMPLITUDE_IMAGE`               | 2D image containing amplitude information for each pixel.                                                                                                                          | NA                     | Yes                                                                                                    | ??  | ??                            |
| `CARTESIAN_ALL`                 | This buffer is deprecated and the  `XYZ` buffer should be used instead.                                                                                                                            | NA                     | Not working: should work? A buffer with the requested buffer_id is not available.: buffer_id: 203      | ??  | Calculated                    |
...
| `CONFIDENCE_IMAGE`              | 2D image containing information about each pixel status.                                                                                                                           | Yes - Only 3D          | Yes                                                                                                    | ??  | Native                        |
| `DIAGNOSTIC`                    | Provides some diagnostic information. See[details below](#diagnostic-buffer).                                                                                                      | NA                     | Yes                                                                                                    | ??  | ??                            |
| `EXPOSURE_TIME`                 | Exposure times used for the last frame.                                                                                                                                            | NA                     | Yes                                                                                                    | ??  | ??                            |
| `EXTRINSIC_CALIB`               | Current values of the optical system to user coordinate transformation for the port currently targeted by the`FrameGrabber`. <br>Can also be retrieved with the `TOF_INFO` buffer. | Yes - Only 3D          | Yes                                                                                                    | ??  | Calculated                    |
| `GRAYSCALE_IMAGE`               | ??                                                                                                                                                                                 | NA                     | NA                                                                                                     | ??  | ??                            |
| `INTRINSIC_CALIB`               | The intrinsic parameters for the port or camera currently targeted by the`FrameGrabber`.                                                                                           | Yes - Only 3D          | Yes                                                                                                    | ??  | Native                        |
| `INVERSE_INTRINSIC_CALIBRATION` | The inverse intrinsic parameters for the port or camera currently targeted by the`FrameGrabber`. <br>                                                                              | Yes - Only 3D          | Yes                                                                                                    | ??  | Native                        |
| `JPEG_IMAGE`                    | The 2D RGB image.                                                                                                                                                                  | Yes - Only RGB         | NA                                                                                                     | NA  | Native                        |
| `JSON_DIAGNOSTIC`               | ??                                                                                                                                                                                 | NA                     | Not working. Should work? Lib: A buffer with the requested buffer_id is not available.: buffer_id: 305 | ??  | ??                            |
| `JSON_MODEL`                    | For internal use only.                                                                                                                                                             | NA                     | Yes                                                                                                    | NA  | ??                            |
| `MONOCHROM_2D`                  | For O2I devices only.                                                                                                                                                              | NA                     | NA                                                                                                     | ??  | ??                            |
| `MONOCHROM_2D_12BIT`            | For O2I devices only.                                                                                                                                                              | NA                     | NA                                                                                                     | ??  | ??                            |
| `NORM_AMPLITUDE_IMAGE`          | The normalized amplitude image                                                                                                                                                     | Yes - Only 3D          | Yes                                                                                                    | x   |                               |
...
| `RADIAL_DISTANCE_IMAGE`         | 2D image containing the radial distance value for each pixel.                                                                                                                      | Yes - Only 3D          | Yes                                                                                                    | ??  | Native                        |
| `RADIAL_DISTANCE_NOISE`         | 2D image containing the distance noise value for each pixel.                                                                                                                       | Yes - Only 3D          | NA                                                                                                     | NA  | Native                        |
| `REFLECTIVITY`                  | 2D image containing the estimated IR reflectivity (in percent).                                                                                                                    | Yes - Only 3D          | NA                                                                                                     | NA  | Native                        |
| `RGB_INFO`                      | Contains various information about the RGB camera and the latest RGB frame (see[`RGBInfoV1`](ADDLINK))                                                                             | Yes - Only RGB         | NA                                                                                                     | NA  | Native                        |
| `TOF_INFO`                      | Contains various information about the TOF camera and the latest TOF frame (see[`TOFInfoV4`](ADDLINK))                                                                             | Yes - Only 3D          | NA                                                                                                     | NA  | Native                        |
...
| `XYZ`                           | The point cloud in Cartesian coordinates.                                                                                                                                          | Yes - Only 3D          | Yes                                                                                                    | NA  | Calculated                    |
