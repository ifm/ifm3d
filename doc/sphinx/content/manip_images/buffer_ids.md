...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------ | --- | ----------------------------- |
| `ALGO_DEBUG`                    | Proprietary data used for troubleshooting by ifm. For internal use only.                                                                                                           | Not working: should work?  | NA                                                                                                     | ??  | Native                        |
...
| `INTRINSIC_CALIB`               | The intrinsic parameters for the port or camera currently targeted by the`FrameGrabber`.                                                                                           | x                          | Yes                                                                                                    | ??  | Native                        |
| `INVERSE_INTRINSIC_CALIBRATION` | The inverse intrinsic parameters for the port or camera currently targeted by the`FrameGrabber`. <br>                                                                              | x                          | Yes                                                                                                    | ??  | Native                        |
| `JPEG_IMAGE`                    | The 2D RGB image.                                                                                                                                                                  | x                          | NA                                                                                                     | NA  | Native                        |
| `JSON_DIAGNOSTIC`               | ??                                                                                                                                                                                 | ??                         | Not working. Should work? Lib: A buffer with the requested buffer_id is not available.: buffer_id: 305 | ??  | ??                            |
