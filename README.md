...
:warning: branch `o3r/main` is an early adopters version which may/will contain changes to the interface in the future.
...
<table>
  ...
  <tr>
    <td>stlimage</td>
    <td>This is an officially supported and alternate data container to the
    default Image module. This module provides a STL Image container without any
