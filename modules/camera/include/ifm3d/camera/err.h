...
extern IFM3D_CAMERA_EXPORT const int IFM3D_INVALID_PORT;
extern IFM3D_CAMERA_EXPORT const int IFM3D_TOOL_COMMAND_UNSUPPORTED_DEVICE;
extern IFM3D_CAMERA_EXPORT const int IFM3D_UNSUPPORTED_SCHEMA_ON_DEVICE;
