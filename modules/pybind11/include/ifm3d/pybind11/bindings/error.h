...
bind_error(pybind11::module_& m)
{
  ...
  auto pytype = py::reinterpret_borrow<py::object>(
    reinterpret_cast<PyObject*>(&PyType_Type));
  py::dict attributes;

  auto code_getter = py::cpp_function(
    [](const py::object& self) -> py::int_ { return self.attr("_code"); });

  auto message_getter = py::cpp_function(
    [](const py::object& self) -> py::str { return self.attr("_message"); });

  auto what_getter = py::cpp_function(
    [](const py::object& self) -> py::str { return self.attr("_what"); });
  ...
  py::dict error_attributes(
    ...
    "__str__"_a = py::cpp_function(
      [](const py::object& self) { return self.attr("what"); },
      py::is_method(py::none())),
