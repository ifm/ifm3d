...
bind_logging(pybind11::module_& m)
{
  ...
  log_writer.def(py::init<>());

  log_writer.def("write",
  ...
  py::class_<ifm3d::LogFormatterText> log_formatter_text(m,
                                                         "LogFormatterText",
                                                         R"(
      Formats a give LogEntry as a human readable text line
    )");

  log_formatter_text.def_static("format",
  ...
  py::class_<ifm3d::LogFormatterJson> log_formatter_json(m,
                                                         "LogFormatterJson",
                                                         R"(
      Formats a give LogEntry as a json object
    )");

  log_formatter_json.def_static("format",
  ...
  py::class_<ifm3d::Logger> logger(m,
                                   "Logger",
                                   R"(
