...
bind_struct_odsinfov1(pybind11::module_& m)
{
  ...
  py::class_<ifm3d::ODSInfoV1, ifm3d::ODSInfoV1::Ptr> ods_info_v1(m,
                                                                  "ODSInfoV1",
                                                                  R"(
        Class for managing an instance of an struct ODSInfoV1
      )");

  ods_info_v1.def(py::init<>(),
                  R"(
        Constructor
      )");

  ods_info_v1.def_readonly("timestamp_ns",
                           &ifm3d::ODSInfoV1::timestamp_ns,
                           R"(
        Timestamp of zone information [ns]
      )");

  ods_info_v1.def_readonly("zone_occupied",
  ...
  ods_info_v1.def_readonly("zone_config_id",
