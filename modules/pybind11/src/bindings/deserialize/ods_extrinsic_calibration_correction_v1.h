...
{
  // clang-format off
  py::class_<ifm3d::ODSExtrinsicCalibrationCorrectionV1, ifm3d::ODSExtrinsicCalibrationCorrectionV1::Ptr>ods_extrinsic_calibration_correction_v1(
    m,
    ...
    ods_extrinsic_calibration_correction_v1.def(
    py::init<>(),
      R"(
          Constructor
        )");
